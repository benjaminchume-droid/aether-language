...
impl Type {
    ...
    pub fn compatible_with(&self,other:&Self)->bool{match(self,other){(a,b)if a==b=>true,(Self::Struct(a),Self::Enum(b))|(Self::Enum(a),Self::Struct(b))=>a==b,(a,b)if a.is_numeric()&&b.is_numeric()=>true,(Self::Unknown,_)|(_,Self::Unknown)=>true,(Self::Array(a),Self::Array(b))=>a.compatible_with(b),_=>false}}
